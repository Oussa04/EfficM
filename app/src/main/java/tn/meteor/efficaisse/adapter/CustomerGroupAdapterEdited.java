...
public class CustomerGroupAdapterEdited extends RecyclerView.Adapter<CustomerGroupAdapterEdited.CustomerGroupHolder> {
    ...
    public CustomerGroupAdapterEdited(Context mContext, CustomerGroupAdapterListener listener, List<CustomerGroup> customerGroupList) {
